 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ja(n,e,t){return`firebase:${n}:${e}:${t}`}class Si{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:o,name:l}=this.auth;this.fullUserKey=ja(this.userKey,o.apiKey,l),this.fullPersistenceKey=ja("persistence",o.apiKey,l),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Tn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new Si(xn(mg),e,s);const o=(await Promise.all(t.map(async m=>{if(await m._isAvailable())return m}))).filter(m=>m);let l=o[0]||xn(mg);const c=ja(s,e.config.apiKey,e.name);let h=null;for(const m of t)try{const _=await m._get(c);if(_){const y=Tn._fromJSON(e,_);m!==l&&(h=y),l=m;break}}catch{}const p=o.filter(m=>m._shouldAllowMigration);return!l._shouldAllowMigration||!p.length?new Si(l,e,s):(l=p[0],h&&await l._set(c,h.toJSON()),await Promise.all(t.map(async m=>{if(m!==l)try{await m._remove(c)}catch{}})),new Si(l,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yd{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return kn("not implemented")}_getIdTokenResponse(e){return kn("not implemented")}_linkToIdToken(e,t){return kn("not implemented")}_getReauthenticationResolver(e){return kn("not implemented")}}async function iS(n,e){return fr(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lr{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,s,o=!1){const l=await Tn._fromIdTokenResponse(e,s,o),c=wg(s);return new Lr({user:l,providerId:c,_tokenResponse:s,operationType:t})}static async _forOperation(e,t,s){await e._updateTokensIfNecessary(s,!0);const o=wg(s);return new Lr({user:e,providerId:o,_tokenResponse:s,operationType:t})}}function wg(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k_ extends S_{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}k_.type="SESSION";const T_=k_;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cn(){return window}function TS(n){cn().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hI={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},fI=500,pI=600,mI="_blank",gI="http://localhost";class kg{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function vI(n,e,t,s=fI,o=pI){const l=Math.max((window.screen.availHeight-o)/2,0).toString(),c=Math.max((window.screen.availWidth-s)/2,0).toString();let h="";const p=Object.assign(Object.assign({},hI),{width:s.toString(),height:o.toString(),top:l,left:c}),m=dt().toLowerCase();t&&(h=u_(m)?mI:t),a_(m)&&(e=e||gI,p.scrollbars="yes");const _=Object.entries(p).reduce((w,[T,N])=>`${w}${T}=${N},`,"");if(j1(m)&&h!=="_self")return _I(e||"",h),new kg(null);const y=window.open(e||"",h,_);re(y,n,"popup-blocked");try{y.focus()}catch{}return new kg(y)}function _I(n,e){const t=document.createElement("a");t.href=n,t.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function th(n){let e;const t=await kl(n.appConfig,s=>{const o=ZI(s),l=ek(n,o);return e=l.registrationPromise,l.installationEntry});return t.fid===vd?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function ZI(n){const e=n||{fid:GI(),registrationStatus:0};return q_(e)}function ek(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(Dr.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},s=tk(n,t);return{installationEntry:t,registrationPromise:s}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:nk(n)}:{installationEntry:e}}async function tk(n,e){try{const t=await WI(n,e);return Za(n.appConfig,t)}catch(t){throw F_(t)&&t.customData.serverCode===409?await K_(n.appConfig):await Za(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function nk(n){let e=await Pg(n.appConfig);for(;e.registrationStatus===1;)await W_(100),e=await Pg(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:s}=await th(n);return s||t}return e}function Pg(n){return kl(n,e=>{if(!e)throw Dr.create("installation-not-found");return q_(e)})}function q_(n){return rk(n)?{fid:n.fid,registrationStatus:0}:n}function rk(n){return n.registrationStatus===1&&n.registrationTime+L_<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ik({appConfig:n,heartbeatServiceProvider:e},t){const s=sk(n,t),o=zI(n,t),l=e.getImmediate({optional:!0});if(l){const m=await l.getHeartbeatsHeader();m&&o.append("x-firebase-client",m)}const c={installation:{sdkVersion:D_,appId:n.appId}},h={method:"POST",headers:o,body:JSON.stringify(c)},p=await $_(()=>fetch(s,h));if(p.ok){const m=await p.json();return U_(m)}else throw await z_("Generate Auth Token",p)}function sk(n,{fid:e}){return`${j_(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nh(n,e=!1){let t;const s=await kl(n.appConfig,l=>{if(!Y_(l))throw Dr.create("not-registered");const c=l.authToken;if(!e&&lk(c))return l;if(c.requestStatus===1)return t=ok(n,e),l;{if(!navigator.onLine)throw Dr.create("app-offline");const h=ck(l);return t=ak(n,h),h}});return t?await t:s.authToken}async function ok(n,e){let t=await bg(n.appConfig);for(;t.authToken.requestStatus===1;)await W_(100),t=await bg(n.appConfig);const s=t.authToken;return s.requestStatus===0?nh(n,e):s}function bg(n){return kl(n,e=>{if(!Y_(e))throw Dr.create("not-registered");const t=e.authToken;return dk(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function ak(n,e){try{const t=await ik(n,e),s=Object.assign(Object.assign({},e),{authToken:t});return await Za(n.appConfig,s),t}catch(t){if(F_(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await K_(n.appConfig);else{const s=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Za(n.appConfig,s)}throw t}}function Y_(n){return n!==void 0&&n.registrationStatus===2}function lk(n){return n.requestStatus===2&&!uk(n)}function uk(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+MI}function ck(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function dk(n){return n.requestStatus===1&&n.requestTime+L_<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hk(n){const e=n,{installationEntry:t,registrationPromise:s}=await th(e);return s?s.catch(console.error):nh(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fk(n,e=!1){const t=n;return await pk(t),(await nh(t,e)).token}async function pk(n){const{registrationPromise:e}=await th(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mk(n){if(!n||!n.options)throw Kc("App Configuration");if(!n.name)throw Kc("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw Kc(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Kc(n){return Dr.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q_="installations",gk="installations-internal",vk=n=>{const e=n.getProvider("app").getImmediate(),t=mk(e),s=$r(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},_k=n=>{const e=n.getProvider("app").getImmediate(),t=$r(e,Q_).getImmediate();return{getId:()=>hk(t),getToken:o=>fk(t,o)}};function yk(){dn(new Yt(Q_,vk,"PUBLIC")),dn(new Yt(gk,_k,"PRIVATE"))}yk();Mt(O_,Zd);Mt(O_,Zd,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const el="analytics",wk="firebase_id",Ek="origin",Ck=60*1e3,Sk="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",rh="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kk(n){if(!n.startsWith(rh)){const e=Nt.create("invalid-gtag-resource",{gtagURL:n});return Et.warn(e.message),""}return n}function J_(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function Tk(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function xk(n,e){const t=Tk("firebase-js-sdk-policy",{createScriptURL:kk}),s=document.createElement("script"),o=`${rh}?l=${n}&id=${e}`;s.src=t?t==null?void 0:t.createScriptURL(o):o,s.async=!0,document.head.appendChild(s)}function Nk(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function Rk(n,e,t,s,o,l){const c=s[o];try{if(c)await e[c];else{const p=(await J_(t)).find(m=>m.measurementId===o);p&&await e[p.appId]}}catch(h){Et.error(h)}n("config",o,l)}async function Pk(n,e,t,s,o){try{let l=[];if(o&&o.send_to){let c=o.send_to;Array.isArray(c)||(c=[c]);const h=await J_(t);for(const p of c){const m=h.find(y=>y.measurementId===p),_=m&&e[m.appId];if(_)l.push(_);else{l=[];break}}}l.length===0&&(l=Object.values(e)),await Promise.all(l),n("event",s,o||{})}catch(l){Et.error(l)}}function bk(n,e,t,s){async function o(l,...c){try{if(l==="event"){const[h,p]=c;await Pk(n,e,t,h,p)}else if(l==="config"){const[h,p]=c;await Rk(n,e,t,s,h,p)}else if(l==="consent"){const[h,p]=c;n("consent",h,p)}else if(l==="get"){const[h,p,m]=c;n("get",h,p,m)}else if(l==="set"){const[h]=c;n("set",h)}else n(l,...c)}catch(h){Et.error(h)}}return o}function Ak(n,e,t,s,o){let l=function(...c){window[s].push(arguments)};return window[o]&&typeof window[o]=="function"&&(l=window[o]),window[o]=bk(l,n,e,t),{gtagCore:l,wrappedGtag:window[o]}}function Ok(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(rh)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lk=30,Dk=1e3;class Mk{constructor(e={},t=Dk){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const X_=new Mk;function Fk(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function jk(n){var e;const{appId:t,apiKey:s}=n,o={method:"GET",headers:Fk(s)},l=Sk.replace("{app-id}",t),c=await fetch(l,o);if(c.status!==200&&c.status!==304){let h="";try{const p=await c.json();!((e=p.error)===null||e===void 0)&&e.message&&(h=p.error.message)}catch{}throw Nt.create("config-fetch-failed",{httpStatus:c.status,responseMessage:h})}return c.json()}async function Uk(n,e=X_,t){const{appId:s,apiKey:o,measurementId:l}=n.options;if(!s)throw Nt.create("no-app-id");if(!o){if(l)return{measurementId:l,appId:s};throw Nt.create("no-api-key")}const c=e.getThrottleMetadata(s)||{backoffCount:0,throttleEndTimeMillis:Date.now()},h=new $k;return setTimeout(async()=>{h.abort()},Ck),Z_({appId:s,apiKey:o,measurementId:l},c,h,e)}async function Z_(n,{throttleEndTimeMillis:e,backoffCount:t},s,o=X_){var l;const{appId:c,measurementId:h}=n;try{await zk(s,e)}catch(p){if(h)return Et.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${h} provided in the "measurementId" field in the local Firebase config. [${p==null?void 0:p.message}]`),{appId:c,measurementId:h};throw p}try{const p=await jk(n);return o.deleteThrottleMetadata(c),p}catch(p){const m=p;if(!Bk(m)){if(o.deleteThrottleMetadata(c),h)return Et.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${h} provided in the "measurementId" field in the local Firebase config. [${m==null?void 0:m.message}]`),{appId:c,measurementId:h};throw p}const _=Number((l=m==null?void 0:m.customData)===null||l===void 0?void 0:l.httpStatus)===503?ng(t,o.intervalMillis,Lk):ng(t,o.intervalMillis),y={throttleEndTimeMillis:Date.now()+_,backoffCount:t+1};return o.setThrottleMetadata(c,y),Et.debug(`Calling attemptFetch again in ${_} millis`),Z_(n,y,s,o)}}function zk(n,e){return new Promise((t,s)=>{const o=Math.max(e-Date.now(),0),l=setTimeout(t,o);n.addEventListener(()=>{clearTimeout(l),s(Nt.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Bk(n){if(!(n instanceof fn)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class $k{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function Wk(n,e,t,s,o){if(o&&o.global){n("event",t,s);return}else{const l=await e,c=Object.assign(Object.assign({},s),{send_to:l});n("event",t,c)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vk(){if(Wv())try{await Vv()}catch(n){return Et.warn(Nt.create("indexeddb-unavailable",{errorInfo:n==null?void 0:n.toString()}).message),!1}else return Et.warn(Nt.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Hk(n,e,t,s,o,l,c){var h;const p=Uk(n);p.then(T=>{t[T.measurementId]=T.appId,n.options.measurementId&&T.measurementId!==n.options.measurementId&&Et.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${T.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(T=>Et.error(T)),e.push(p);const m=Vk().then(T=>{if(T)return s.getId()}),[_,y]=await Promise.all([p,m]);Ok(l)||xk(l,_.measurementId),o("js",new Date);const w=(h=c==null?void 0:c.config)!==null&&h!==void 0?h:{};return w[Ek]="firebase",w.update=!0,y!=null&&(w[wk]=y),o("config",_.measurementId,w),_.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gk{constructor(e){this.app=e}_delete(){return delete Bs[this.app.options.appId],Promise.resolve()}}let Bs={},Ag=[];const Og={};let qc="dataLayer",Kk="gtag",Lg,ey,Dg=!1;function qk(){const n=[];if(zv()&&n.push("This is a browser extension environment."),XE()||n.push("Cookies are not available."),n.length>0){const e=n.map((s,o)=>`(${o+1}) ${s}`).join(" "),t=Nt.create("invalid-analytics-context",{errorInfo:e});Et.warn(t.message)}}function Yk(n,e,t){qk();const s=n.options.appId;if(!s)throw Nt.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)Et.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Nt.create("no-api-key");if(Bs[s]!=null)throw Nt.create("already-exists",{id:s});if(!Dg){Nk(qc);const{wrappedGtag:l,gtagCore:c}=Ak(Bs,Ag,Og,qc,Kk);ey=l,Lg=c,Dg=!0}return Bs[s]=Hk(n,Ag,Og,e,Lg,qc,t),new Gk(n)}function Qk(n=Wd()){n=nt(n);const e=$r(n,el);return e.isInitialized()?e.getImmediate():Jk(n)}function Jk(n,e={}){const t=$r(n,el);if(t.isInitialized()){const o=t.getImmediate();if(Ys(e,t.getOptions()))return o;throw Nt.create("already-initialized")}return t.initialize({options:e})}function Xk(n,e,t,s){n=nt(n),Wk(ey,Bs[n.app.options.appId],e,t,s).catch(o=>Et.error(o))}const Mg="@firebase/analytics",Fg="0.10.11";function Zk(){dn(new Yt(el,(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("installations-internal").getImmediate();return Yk(s,o,t)},"PUBLIC")),dn(new Yt("analytics-internal",n,"PRIVATE")),Mt(Mg,Fg),Mt(Mg,Fg,"esm2017");function n(e){try{const t=e.getProvider(el).getImmediate();return{logEvent:(s,o,l)=>Xk(t,s,o,l)}}catch(t){throw Nt.create("interop-component-reg-failed",{reason:t})}}}Zk();var jg={};const Ug="@firebase/database",zg="1.0.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nT{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return pn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ny=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new tT(e)}}catch{}return new nT},Ar=ny("localStorage"),rT=ny("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=new wl("@firebase/database"),iT=function(){let n=1;return function(){return n++}}(),ry=function(n){const e=lC(n),t=new iC;t.update(e);const s=t.digest();return Ud.encodeByteArray(s)},fo=function(...n){let e="";for(let t=0;t<n.length;t++){const s=n[t];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=fo.apply(null,s):typeof s=="object"?e+=Je(s):e+=s,e+=" "}return e};let $s=null,Bg=!0;const sT=function(n,e){B(!e,"Can't turn on custom loggers persistently."),ki.logLevel=Se.VERBOSE,$s=ki.log.bind(ki)},et=function(...n){if(Bg===!0&&(Bg=!1,$s===null&&rT.get("logging_enabled")===!0&&sT()),$s){const e=fo.apply(null,n);$s(e)}},po=function(n){return function(...e){et(n,...e)}},_d=function(...n){const e="FIREBASE INTERNAL ERROR: "+fo(...n);ki.error(e)},Ln=function(...n){const e=`FIREBASE FATAL ERROR: ${fo(...n)}`;throw ki.error(e),new Error(e)},ct=function(...n){const e="FIREBASE WARNING: "+fo(...n);ki.warn(e)},oT=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&ct("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},ih=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},aT=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Ri="[MIN_NAME]",Fr="[MAX_NAME]",Vr=function(n,e){if(n===e)return 0;if(n===Ri||e===Fr)return-1;if(e===Ri||n===Fr)return 1;{const t=$g(n),s=$g(e);return t!==null?s!==null?t-s===0?n.length-e.length:t-s:-1:s!==null?1:n<e?-1:1}},lT=function(n,e){return n===e?0:n<e?-1:1},Ps=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+Je(e))},sh=function(n){if(typeof n!="object"||n===null)return Je(n);const e=[];for(const s in n)e.push(s);e.sort();let t="{";for(let s=0;s<e.length;s++)s!==0&&(t+=","),t+=Je(e[s]),t+=":",t+=sh(n[e[s]]);return t+="}",t},iy=function(n,e){const t=n.length;if(t<=e)return[n];const s=[];for(let o=0;o<t;o+=e)o+e>t?s.push(n.substring(o,t)):s.push(n.substring(o,o+e));return s};function tt(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const sy=function(n){B(!ih(n),"Invalid JSON number");const e=11,t=52,s=(1<<e-1)-1;let o,l,c,h,p;n===0?(l=0,c=0,o=1/n===-1/0?1:0):(o=n<0,n=Math.abs(n),n>=Math.pow(2,1-s)?(h=Math.min(Math.floor(Math.log(n)/Math.LN2),s),l=h+s,c=Math.round(n*Math.pow(2,t-h)-Math.pow(2,t))):(l=0,c=Math.round(n/Math.pow(2,1-s-t))));const m=[];for(p=t;p;p-=1)m.push(c%2?1:0),c=Math.floor(c/2);for(p=e;p;p-=1)m.push(l%2?1:0),l=Math.floor(l/2);m.push(o?1:0),m.reverse();const _=m.join("");let y="";for(p=0;p<64;p+=8){let w=parseInt(_.substr(p,8),2).toString(16);w.length===1&&(w="0"+w),y=y+w}return y.toLowerCase()},uT=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},cT=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function dT(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const s=new Error(n+" at "+e._path.toString()+": "+t);return s.code=n.toUpperCase(),s}const hT=new RegExp("^-?(0*)\\d{1,10}$"),fT=-2147483648,pT=2147483647,$g=function(n){if(hT.test(n)){const e=Number(n);if(e>=fT&&e<=pT)return e}return null},Ui=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw ct("Exception was thrown by user callback.",t),e},Math.floor(0))}},mT=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Ws=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gT{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){ct(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vT{constructor(e,t,s){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(o=>this.auth_=o)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(et("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',ct(e)}}class Ba{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Ba.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yT{constructor(){this.counters_={}}incrementCounter(e,t=1){pn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return $E(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc={},Qc={};function ah(n){const e=n.toString();return Yc[e]||(Yc[e]=new yT),Yc[e]}function wT(n,e){const t=n.toString();return Qc[t]||(Qc[t]=e()),Qc[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ET{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let o=0;o<s.length;++o)s[o]&&Ui(()=>{this.onMessage_(s[o])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wg="start",CT="close",ST="pLPCommand",IT="pRTLPCB",vy="id",_y="pw",yy="ser",kT="cb",TT="seg",xT="ts",NT="d",RT="dframe",wy=1870,Ey=30,PT=wy-Ey,bT=25e3,AT=3e4;class Ei{constructor(e,t,s,o,l,c,h){this.connId=e,this.repoInfo=t,this.applicationId=s,this.appCheckToken=o,this.authToken=l,this.transportSessionId=c,this.lastSessionId=h,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=po(e),this.stats_=ah(t),this.urlFn=p=>(this.appCheckToken&&(p[yd]=this.appCheckToken),gy(t,py,p))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new ET(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(AT)),aT(()=>{if(this.isClosed_)return;this.scriptTagHolder=new lh((...l)=>{const[c,h,p,m,_]=l;if(this.incrementIncomingBytes_(l),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,c===Wg)this.id=h,this.password=p;else if(c===CT)h?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(h,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+c)},(...l)=>{const[c,h]=l;this.incrementIncomingBytes_(l),this.myPacketOrderer.handleResponse(c,h)},()=>{this.onClosed_()},this.urlFn);const s={};s[Wg]="t",s[yy]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[kT]=this.scriptTagHolder.uniqueCallbackIdentifier),s[oy]=oh,this.transportSessionId&&(s[ay]=this.transportSessionId),this.lastSessionId&&(s[dy]=this.lastSessionId),this.applicationId&&(s[hy]=this.applicationId),this.appCheckToken&&(s[yd]=this.appCheckToken),typeof location<"u"&&location.hostname&&cy.test(location.hostname)&&(s[ly]=uy);const o=this.urlFn(s);this.log_("Connecting via long-poll to "+o),this.scriptTagHolder.addTag(o,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Ei.forceAllow_=!0}static forceDisallow(){Ei.forceDisallow_=!0}static isAvailable(){return Ei.forceAllow_?!0:!Ei.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!uT()&&!cT()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Je(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=Dv(t),o=iy(s,PT);for(let l=0;l<o.length;l++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,o.length,o[l]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const s={};s[RT]="t",s[vy]=e,s[_y]=t,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Je(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class lh{constructor(e,t,s,o){this.onDisconnect=s,this.urlFn=o,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=iT(),window[ST+this.uniqueCallbackIdentifier]=e,window[IT+this.uniqueCallbackIdentifier]=t,this.myIFrame=lh.createIFrame_();let l="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(l='<script>document.domain="'+document.domain+'";<\/script>');const c="<html><body>"+l+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(c),this.myIFrame.doc.close()}catch(h){et("frame writing exception"),h.stack&&et(h.stack),et(h)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||et("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[vy]=this.myID,e[_y]=this.myPW,e[yy]=this.currentSerial;let t=this.urlFn(e),s="",o=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Ey+s.length<=wy;){const c=this.pendingSegs.shift();s=s+"&"+TT+o+"="+c.seg+"&"+xT+o+"="+c.ts+"&"+NT+o+"="+c.d,o++}return t=t+s,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,s){this.pendingSegs.push({seg:e,ts:t,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const s=()=>{this.outstandingRequests.delete(t),this.newRequest_()},o=setTimeout(s,Math.floor(bT)),l=()=>{clearTimeout(o),s()};this.addTag(e,l)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const o=s.readyState;(!o||o==="loaded"||o==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),t())},s.onerror=()=>{et("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new ue(Ri,e),o=new ue(Ri,t);return this.compare(s,o)!==0}minPost(){return ue.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Aa;class Ty extends Tl{static get __EMPTY_NODE(){return Aa}static set __EMPTY_NODE(e){Aa=e}compare(e,t){return Vr(e.name,t.name)}isDefinedOn(e){throw Di("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return ue.MIN}maxPost(){return new ue(Fr,Aa)}makePost(e,t){return B(typeof e=="string","KeyIndex indexValue must always be a string."),new ue(e,Aa)}toString(){return".key"}}const Ti=new Ty;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZT(n,e){return Vr(n.name,e.name)}function hh(n,e){return Vr(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ux extends Tl{compare(e,t){const s=e.node.compareTo(t.node);return s===0?Vr(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return ue.MIN}maxPost(){return ue.MAX}makePost(e,t){const s=Qe(e);return new ue(t,s)}toString(){return".value"}}const cx=new ux;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dl;function aN(n){B(!dl,"__referenceConstructor has already been defined"),dl=n}function lN(){return B(dl,"Reference.ts has not been loaded"),dl}let uN=1;class hv{constructor(e){this.listenProvider_=e,this.syncPointTree_=new xe(null),this.pendingWriteTree_=Fx(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Hy(n,e,t,s,o){return kx(n.pendingWriteTree_,e,t,s,o),o?zi(n,new jr(mh(),e,t)):[]}function cN(n,e,t,s){Tx(n.pendingWriteTree_,e,t,s);const o=xe.fromObject(t);return zi(n,new bi(mh(),e,o))}function sr(n,e,t=!1){const s=xx(n.pendingWriteTree_,e);if(Nx(n.pendingWriteTree_,e)){let l=new xe(null);return s.snap!=null?l=l.set(_e(),!0):tt(s.children,c=>{l=l.set(new Ie(c),!0)}),zi(n,new ol(s.path,l,t))}else return[]}function Rl(n,e,t){return zi(n,new jr(gh(),e,t))}function dN(n,e,t){const s=xe.fromObject(t);return zi(n,new bi(gh(),e,s))}function hN(n,e){return zi(n,new io(gh(),e))}function fN(n,e,t){const s=Ih(n,t);if(s){const o=kh(s),l=o.path,c=o.queryId,h=yt(l,e),p=new io(vh(c),h);return Th(n,l,p)}else return[]}function Nd(n,e,t,s,o=!1){const l=e._path,c=n.syncPointTree_.get(l);let h=[];if(c&&(e._queryIdentifier==="default"||Vy(c,e))){const p=oN(c,e,t,s);rN(c)&&(n.syncPointTree_=n.syncPointTree_.remove(l));const m=p.removed;if(h=p.events,!o){const _=m.findIndex(w=>w._queryParams.loadsAllData())!==-1,y=n.syncPointTree_.findOnPath(l,(w,T)=>cr(T));if(_&&!y){const w=n.syncPointTree_.subtree(l);if(!w.isEmpty()){const T=gN(w);for(let N=0;N<T.length;++N){const b=T[N],O=b.query,L=qy(n,b);n.listenProvider_.startListening(Gs(O),hl(n,O),L.hashFn,L.onComplete)}}}!y&&m.length>0&&!s&&(_?n.listenProvider_.stopListening(Gs(e),null):m.forEach(w=>{const T=n.queryToTagMap.get(Pl(w));n.listenProvider_.stopListening(Gs(w),T)}))}vN(n,m)}return h}function pN(n,e,t,s){const o=Ih(n,s);if(o!=null){const l=kh(o),c=l.path,h=l.queryId,p=yt(c,e),m=new jr(vh(h),p,t);return Th(n,c,m)}else return[]}function mN(n,e,t,s){const o=Ih(n,s);if(o){const l=kh(o),c=l.path,h=l.queryId,p=yt(c,e),m=xe.fromObject(t),_=new bi(vh(h),p,m);return Th(n,c,_)}else return[]}function fv(n,e,t,s=!1){const o=e._path;let l=null,c=!1;n.syncPointTree_.foreachOnPath(o,(w,T)=>{const N=yt(w,o);l=l||xi(T,N),c=c||cr(T)});let h=n.syncPointTree_.get(o);h?(c=c||cr(h),l=l||xi(h,_e())):(h=new eN,n.syncPointTree_=n.syncPointTree_.set(o,h));let p;l!=null?p=!0:(p=!1,l=ie.EMPTY_NODE,n.syncPointTree_.subtree(o).foreachChild((T,N)=>{const b=xi(N,_e());b&&(l=l.updateImmediateChild(T,b))}));const m=Vy(h,e);if(!m&&!e._queryParams.loadsAllData()){const w=Pl(e);B(!n.queryToTagMap.has(w),"View does not exist, but we have a tag");const T=_N();n.queryToTagMap.set(w,T),n.tagToQueryMap.set(T,w)}const _=_h(n.pendingWriteTree_,o);let y=sN(h,e,t,_,l,p);if(!m&&!c&&!s){const w=Wy(h,e);y=y.concat(yN(n,e,w))}return y}function Sh(n,e,t){const o=n.pendingWriteTree_,l=n.syncPointTree_.findOnPath(e,(c,h)=>{const p=yt(c,e),m=xi(h,p);if(m)return m});return My(o,e,l,t,!0)}function zi(n,e){return Gy(e,n.syncPointTree_,null,_h(n.pendingWriteTree_,_e()))}function Gy(n,e,t,s){if(de(n.path))return Ky(n,e,t,s);{const o=e.get(_e());t==null&&o!=null&&(t=xi(o,_e()));let l=[];const c=le(n.path),h=n.operationForChild(c),p=e.children.get(c);if(p&&h){const m=t?t.getImmediateChild(c):null,_=Fy(s,c);l=l.concat(Gy(h,p,m,_))}return o&&(l=l.concat(Ch(o,n,s,t))),l}}function Ky(n,e,t,s){const o=e.get(_e());t==null&&o!=null&&(t=xi(o,_e()));let l=[];return e.children.inorderTraversal((c,h)=>{const p=t?t.getImmediateChild(c):null,m=Fy(s,c),_=n.operationForChild(c);_&&(l=l.concat(Ky(_,h,p,m)))}),o&&(l=l.concat(Ch(o,n,s,t))),l}function qy(n,e){const t=e.query,s=hl(n,t);return{hashFn:()=>(Qx(e)||ie.EMPTY_NODE).hash(),onComplete:o=>{if(o==="ok")return s?fN(n,t._path,s):hN(n,t._path);{const l=dT(o,t);return Nd(n,t,null,l)}}}}function hl(n,e){const t=Pl(e);return n.queryToTagMap.get(t)}function Pl(n){return n._path.toString()+"$"+n._queryIdentifier}function Ih(n,e){return n.tagToQueryMap.get(e)}function kh(n){const e=n.indexOf("$");return B(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Ie(n.substr(0,e))}}function Th(n,e,t){const s=n.syncPointTree_.get(e);B(s,"Missing sync point for query tag that we're tracking");const o=_h(n.pendingWriteTree_,e);return Ch(s,t,o,null)}function gN(n){return n.fold((e,t,s)=>{if(t&&cr(t))return[Nl(t)];{let o=[];return t&&(o=$y(t)),tt(s,(l,c)=>{o=o.concat(c)}),o}})}function Gs(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(lN())(n._repo,n._path):n}function vN(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const o=Pl(s),l=n.queryToTagMap.get(o);n.queryToTagMap.delete(o),n.tagToQueryMap.delete(l)}}}function _N(){return uN++}function yN(n,e,t){const s=e._path,o=hl(n,e),l=qy(n,t),c=n.listenProvider_.startListening(Gs(e),o,l.hashFn,l.onComplete),h=n.syncPointTree_.subtree(s);if(o)B(!cr(h.value),"If we're adding a query, it shouldn't be shadowed");else{const p=h.fold((m,_,y)=>{if(!de(m)&&_&&cr(_))return[Nl(_).query];{let w=[];return _&&(w=w.concat($y(_).map(T=>T.query))),tt(y,(T,N)=>{w=w.concat(N)}),w}});for(let m=0;m<p.length;++m){const _=p[m];n.listenProvider_.stopListening(Gs(_),hl(n,_))}}return c}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TN=/[\[\].#$\/\u0000-\u001F\u007F]/,xN=/[\[\].#$\u0000-\u001F\u007F]/,ed=10*1024*1024,Ah=function(n){return typeof n=="string"&&n.length!==0&&!TN.test(n)},e0=function(n){return typeof n=="string"&&n.length!==0&&!xN.test(n)},NN=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),e0(n)},RN=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ih(n)||n&&typeof n=="object"&&pn(n,".sv")},t0=function(n,e,t,s){s&&e===void 0||Al(_l(n,"value"),e,t)},Al=function(n,e,t){const s=t instanceof Ie?new HT(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Pr(s));if(typeof e=="function")throw new Error(n+"contains a function "+Pr(s)+" with contents = "+e.toString());if(ih(e))throw new Error(n+"contains "+e.toString()+" "+Pr(s));if(typeof e=="string"&&e.length>ed/3&&yl(e)>ed)throw new Error(n+"contains a string greater than "+ed+" utf8 bytes "+Pr(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let o=!1,l=!1;if(tt(e,(c,h)=>{if(c===".value")o=!0;else if(c!==".priority"&&c!==".sv"&&(l=!0,!Ah(c)))throw new Error(n+" contains an invalid key ("+c+") "+Pr(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);GT(s,c),Al(n,h,s),KT(s)}),o&&l)throw new Error(n+' contains ".value" child '+Pr(s)+" in addition to actual children.")}},PN=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const l=eo(s);for(let c=0;c<l.length;c++)if(!(l[c]===".priority"&&c===l.length-1)){if(!Ah(l[c]))throw new Error(n+"contains an invalid key ("+l[c]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(VT);let o=null;for(t=0;t<e.length;t++){if(s=e[t],o!==null&&Dt(o,s))throw new Error(n+"contains a path "+o.toString()+" that is ancestor of another path "+s.toString());o=s}},bN=function(n,e,t,s){const o=_l(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(o+" must be an object containing the children to replace.");const l=[];tt(e,(c,h)=>{const p=new Ie(c);if(Al(o,h,je(t,p)),uh(p)===".priority"&&!RN(h))throw new Error(o+"contains an invalid value for '"+p.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");l.push(p)}),PN(o,l)},n0=function(n,e,t,s){if(!e0(t))throw new Error(_l(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},AN=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),n0(n,e,t)},Oh=function(n,e){if(le(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},ON=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ah(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!NN(t))throw new Error(_l(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
